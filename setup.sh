...
echo "生成的alias为:"
echo "python使用: \033[34malias $prefix=\"python $current_abs_path/commitPrefix.py \$1\"\033[0m"
echo "python3使用: \033[34malias $prefix=\"python3 $current_abs_path/commitPrefix.py \$1\"\033[0m"
echo "我不知道你用的什么sh工具....."
echo "如果你使用zsh:"
